...
const Material = ({announcements, course, instructor }) => {
    ...
    useEffect(() => {
      axios.get(`${API_BASE_URL}/course/material/${course._id}`,{headers:{'Authorization': get('token')}})
  ...
  const handleSave = () => {
    ...
    axios.post(`${API_BASE_URL}/course/material/${course._id}`,{
      filename : title,
      data : item,
      description : description
  ...
  const handleDelete = (id) => {
    axios.delete(`${API_BASE_URL}/course/material/${id}?course_id=${course._id}`,{headers:{'Authorization':get('token')}})
    .then((resp)=>{   // if no error
  ...
  const handleClickOpenComment = async (id) => {
    ...
    axios.get(`${API_BASE_URL}/comment/file/${id}`,{headers:{'Authorization':get('token')}})
      .then((resp)=>{   // if no error
  ...
  const handleCommentSubmit = async () => {
    ...
    console.log(comment);
    axios.post(`${API_BASE_URL}/comment/file/${announcementId}`,{
      description : comment,
    },{headers:{'Authorization':get('token')}})
