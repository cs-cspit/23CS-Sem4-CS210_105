...
const Announcement = ({course }) => {
  ...
  useEffect(() => {
    axios.get(`${API_BASE_URL}/announcement/course/${course._id}`,{headers:{'Authorization': get('token')}})
  ...
  const handleClickOpenComment = async (id) => {
    ...
    axios.get(`${API_BASE_URL}/comment/announcement/${id}`,{headers:{'Authorization':get('token')}})
      .then((resp)=>{   // if no error
  ...
  const handleEditAnnouncementSave = async () => {
    axios.put(`${API_BASE_URL}/announcement/${announcementEdit._id}`,{
      title : title,
  ...
  const handleSave = () => {
    axios.post(`${API_BASE_URL}/announcement/course/${course._id}`,{
      title : title,
      description : description,
      files : [],
      comments : []
  ...
  const handleDelete = (id) => {
    axios.delete(`${API_BASE_URL}/announcement/${id}`,{headers:{'Authorization':get('token')}})
    .then((resp)=>{   // if no error
  ...
  const handleCommentSubmit = async () => {
    ...
    console.log(comment);
    axios.post(`${API_BASE_URL}/comment/announcement/${announcementId}`,{
      description : comment,
    },{headers:{'Authorization':get('token')}})
