...
export default function EditAssignment({course, created_assignment}) {
  ...
  const handleDeleteClick = (id) => () => {
    ...
    axios.delete(`${API_BASE_URL}/assignment/${delete_row._id}`,{headers:{'Authorization':get('token')}})
  ...
  const processRowUpdate = (newRow) => {
    ...
    axios.put(`${API_BASE_URL}/assignment/${updatedRow._id}`,{
  ...
  const columns = [
    ...
    { 
      ...
      renderCell: (params) => {
        ...
        return <a href={this_link} target="_blank" rel="noreferrer">Assignment</a>;
      },
    },
    {
      field: 'createdAt',
  ...
  // Added
  useEffect(() => {
    axios.get(`${API_BASE_URL}/assignment/course/${course._id}`,{headers:{'Authorization': get('token')}})
    .then((resp)=>{   // if no error
