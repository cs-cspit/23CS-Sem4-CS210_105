...
const loginUser = async (req, res) => {
    try {
        ...
        if (!req.body.email || !req.body.password) {
            return response.badRequestResponse(res, 'Email and password are required');
        }
        ...
        if (!process.env.SECRET) {
            ...
            return response.serverErrorResponse(res, "JWT secret key is not defined");
        }
        ...
        return response.successResponse(res, { token, user: userData });
